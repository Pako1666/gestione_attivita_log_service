...
public class AttivitaRequestValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7939848690269017100L;
   ...
   */
  public static it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder newBuilder() {
    return new it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder();
  }
   ...
   * @return A new AttivitaRequestValue RecordBuilder
   */
  public static it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder newBuilder(it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder other) {
    if (other == null) {
      return new it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder();
    } else {
      return new it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder(other);
    }
  }
   ...
   * @return A new AttivitaRequestValue RecordBuilder
   */
  public static it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder newBuilder(it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue other) {
    if (other == null) {
      return new it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder();
    } else {
      return new it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AttivitaRequestValue>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder setAlias(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder clearAlias() {
      alias = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder setLavorata(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder clearLavorata() {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder setAttivitaPadre(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.gestore_attivita.log_service.kafka.avro.AttivitaRequestValue.Builder clearAttivitaPadre() {
      attivitaPadre = null;
